(function () {
    ...
    appModule.controller('common.views.productionshistorys.index', [
        ...
        function ($scope, $modal, uiGridConstants, productionPlansService) {
            ...
            vm.getproductions = function () {
                ...
                productionPlansService.getProductionPlansList({
                    ...
                    vm.productionplansGridOptions.totalItems = result.totalCount;
                    vm.productionplansGridOptions.data = result.items;
                }).finally(function () {
                    vm.loading = false;
                });
            }
            ...
            vm.showDetails = function (entiy) {
                $modal.open({
                    templateUrl: '~/App/common/views/productionshistorys/detailModal.cshtml',
                    controller: 'common.views.productionshistorys.detailModal as vm',
                    backdrop: 'static',
                    size: 'lg',
                    resolve: {
                        entiy: function () {
