...
using jrt.jcgl.Web.App.Startup;
using jrt.jcgl.Web.Areas.Mpa.Startup;
using jrt.jcgl.Web.Bundling;
using jrt.jcgl.Web.Navigation;
using jrt.jcgl.Web.Routing;
using jrt.jcgl.WebApi;

namespace jrt.jcgl.Web
{
    /// <summary>
