...
using IMTest.Users;
using IMTest.Web.Controllers.Results;
using IMTest.Web.Models.Account;
...
{
    public class AccountController : IMTestControllerBase
    {
        ...
        public AccountController(
            ...
            IIMUserAppService imUserAppService)
        {
        ...
        public ActionResult Test()
        {
            IMRegisterInput dto = new IMRegisterInput();
            return View("Test",dto);
        }

        [HttpPost]
        public ActionResult Test(IMRegisterInput input)
        {
            _imUserAppService.IMRegister(input);
            return View();
        }
        #endregion
    }
